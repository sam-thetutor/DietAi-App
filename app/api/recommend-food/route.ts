...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Prompt for general goal-oriented suggestions
    const prompt = `
        ...
        Guidelines:
        - Analyze the common foods list. If they seem counterproductive to the goal, suggest healthier alternatives or modifications.
        - If common foods align well, suggest complementary healthy foods or meal structures.
        ...
        - Suggestions should be practical tips or general meal concepts.
